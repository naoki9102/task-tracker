...
INSERT INTO `migrations` VALUES (4, '2025_04_08_160328_create_tasks_table', 1);
...
CREATE TABLE `tasks`  (
  ...
  `additional_charges` decimal(10, 2) NULL DEFAULT NULL,
...
-- Records of tasks
-- ----------------------------
INSERT INTO `tasks` VALUES (1, 'Test', 'Test', '2000-01-01', 0.00, 0.00, 0.00, 0.00, '2025-04-08 16:16:03', '2025-04-08 16:30:52');
